...
//#define CC1100_GFSK_1_2_K
//#define CC1100_GFSK_38_4_K
//#define CC1100_GFSK_100_K
//#define CC1100_MSK_250_K
#define CC1100_MSK_500_K
//#define CC1100_OOK_4_8_K
...
public:
    ...
    uint8_t begin(uint8_t SelfAddress, uint8_t Band, uint8_t Channel, uint8_t Power);
    void end(void);

    void spi_write_strobe(uint8_t spi_instr);
    void spi_write_register(uint8_t spi_instr, uint8_t value);
    void spi_write_burst(uint8_t spi_instr, const uint8_t *pArr, uint8_t length);
    ...
    bool wait_for_packet(uint16_t milliseconds);
